    ...
    for checkpoint_name in ['checkpoint.pth.tar', 'model_best.pth.tar']:
        ...
        if not args.no_predictive:
            ...
            if args.artificial_missing_perc > 0:
                ...
                print(f'{{ "seed": {args.seed}, "model": "{model_name}","test_missing_perc": {args.test_artificial_perc}, "train_missing_perc": {args.artificial_missing_perc}, "train_accuracy": {missing_imputation_accuracy}, "test_accuracy": {test_missing_imputation_accuracy} }},')
                sys.exit(0)
